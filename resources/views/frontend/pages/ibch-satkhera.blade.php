...
@section('content')
    <div class="container">
        <h2 style="text-align: center">Islami Bank Community Hospital Satkhira Ltd. Hotline: </h2>
        ...
        <strong>Welcome To Islami Bank Community Hospital,Satkhira Ltd.</strong>
        <p style="text-align: justify">Islami Bank Community Hospital,Satkhira Ltd is a largest and fast growing Hospital in Satkhira. The Hospital has founded 2001. It is a 50 beded hospital. We believe the Hospital will go ahead as a pioneer private Hospital in Satkhira. The Hospital operates its daily activities of the own building. It is 4 storied building in Hospital. It has 03 operation theaters including 01 Eye OT. There are 4 post operative beds. </p>
