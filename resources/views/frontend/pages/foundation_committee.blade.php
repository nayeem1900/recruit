...
@section('content')
    <p style="text-align: center; font-size: 30px;" ><strong>Foundation Committee</strong></p>
    <div class="container">
        <div class="row">
            <div class="col-md-3">
        ...
        <!--<div class="card" style="width: 18rem;">
            ...
            <div class="col-md-9">
                ...
                <div class="card mb-3">
                    ...
                    <div class="col-md-4">
                        <img src="{{url('frontend/images/1557046101_abdullah al - Rajhi.jpg')}}" alt="...">
                    </div>
                    <div class="col-md-12">
                        <div class="card-body">
                ...
                <div class="card mb-3">
                    ...
                    <div class="col-md-4">
                        <img src="{{url('frontend/images/1557045815_Mr Musaid Abdullah A Al-Rajhi.jpg')}}" alt="...">
                    </div>
                    <div class="col-md-12">
                        <div class="card-body">
                            <h5 class="card-title">Member</h5>
                            <p class="card-text" style="text-align: justify">Musaid Abdullah A AlRajhi represents Arabsas Travel & Tourist Agency, Kingdom of Saudi Arabia (K.S.A.) in the Board of Directors of Islami Bank Bangladesh Limited. He is a Business Graduate from Institute of Business Administration, Riadh, K.S.A. in the year 1988. He has long 27 years of working experience during which he served as Branch Manager at Al-Rajhi Bank, General Manager at Al Rajhi Foam & Plastic Factory Ltd. and General Manager at Afnan Water Factory Ltd. A talented and successful businessman, presently he runs the Abdullah Abdul Aziz Al Rajhi & Sons Real Estate Development Co. being its General Manager since 2007. He visited various countries of the world and participated in many international seminars, symposia and conferences.</p>
                        </div>
                    </div>
                ...
                <div class="card mb-3">
                    ...
                    <div class="col-md-4">
                        <img src="{{url('frontend/images/1538573391_Md.-Quamrul-Hasan.jpg')}}" alt="...">
                    </div>
                    <div class="col-md-12">
                        <div class="card-body">
                            <h5 class="card-title">Member</h5>
                ...
                <div class="card mb-3" >
                    ...
                    <div class="col-md-4">
                        <img src="{{url('frontend/images/1572253796_Fashiul Alam.jpg')}}" alt="...">
                    </div>
                    <div class="col-md-12">
                        <div class="card-body">
                            <h5 class="card-title">Member</h5>
