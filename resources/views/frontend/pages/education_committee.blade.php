...
@section('content')
    <p style="text-align: center; font-size: 15px;" ><strong>Executive Committee of Islami Bank Health Educational Institutions (Medical College, Nursing College, Health Technology & Nursing Institute)</strong></p>
    <div class="container">
        <div class="row">
            <div class="col-md-3">
