...
@section('content')
    <div class="container">
        <h1 style="text-align: center">Islami Bank Hospital, Khulna. Hotline:01712068684</h1>
        ...
        <strong>Welcome To Islami Bank Hospital Khulna, Dhaka.</strong>
        <p style="text-align: justify">Islami Bank  Hospital Khulna is a largest and fast growing Hospital in Dhaka. The Hospital has founded 1999. It is a 80 beded hospital. We believe the Hospital will go ahead as a pioneer private Hospital in Dhaka.The Hospital operates its daily activities of the own building. It has 03 operation theaters including 01 Eye OT. </p>
