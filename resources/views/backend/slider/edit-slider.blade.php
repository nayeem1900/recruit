                            ...
                            <div class="card-body" >
                                ...
                                <form method="POST" action="{{route('sliders.update',$editData->id)}}"enctype="multipart/form-data" >
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="h_name" value="{{@$editData->h_name}}" class="form-control form-control-sm"id="h_name">

                                    </div>
                                    <div class="col-md-4">
                                        <label>Slider Long Name  <font style="color: red">*</font></label>
                                        <input type="text" name="p_name" value="{{@$editData->p_name}}" class="form-control form-control-sm"id="p_name">
