                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3>Doctor List
                                    ...
                                    <a class="btn btn-success float-right btn-sm" href="{{route('ibchk.doctor.add')}}"><i class="fa fa-plus-circle"></i> Add Doctor</a>
                                ...
                                <table id="example1" class="table table-bordered table-hover">
                                    ...
                                    @foreach($allData as $key=>$value)
                                        <tr>
                                            ...
                                            <td>
                                                <a title="Edit" class="btn btn-sm btn-primary" href="{{route('ibchk.doctor.edit',$value->id)}}"><i class="fa fa-edit"></i></a>
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="{{route('ibchk.doctor.delete',$value->id)}}" method="post">
                                                                    @csrf
